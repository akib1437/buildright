    ...
    <main className="min-h-screen grid lg:grid-cols-2">
      <div className="blueprint-grid text-paper hidden lg:flex flex-col justify-between p-10">
        ...
        <div>
          ...
          <p className="font-display font-extrabold text-4xl leading-tight max-w-sm">
            One login for estimate requests and status updates.
          </p>
        </div>
      ...
      <div className="flex items-center justify-center p-6 sm:p-10">
        <div className="w-full max-w-sm">
          <Link href="/" className="lg:hidden font-display font-extrabold text-lg">
            ← {SITE.shortName}
          </Link>
          <p className="mt-6 lg:mt-0 font-mono text-[0.68rem] uppercase tracking-[0.2em] text-blueprint">
            {eyebrow}
          </p>
